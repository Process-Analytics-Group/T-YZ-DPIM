import numpy as np
from Expo_Package.cut_counting import Parameters
...
def __dp_tree(log, goalEpsilon, dfg, threshold, root, act_key, use_msd, remove_noise=False):
    ...
    # get number of executes cuts in process structure tree
    global cutdict
    cutdict, numCuts = Parameters.__get_cutCount(log, dfg, threshold, root, act_key, use_msd, remove_noise=False)
...
def choose_cut():
    ...
    # if maximum score is greater than the maximum numpy can work with
